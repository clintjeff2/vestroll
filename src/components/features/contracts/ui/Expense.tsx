...
function ContractExpense({ contract }: { contract: Record<string, unknown> }) {
          ...
          <div className="flex space-x-3 divide-x divide-gray-300">
            <div className="flex gap-2 pr-6">
              <div className="flex items-center">
                <img src={currencies[0].icon} alt="fiat" className="w-8 h-8" />
              </div>
              <div>
                <small className="text-gray-400">Total expenses</small>
                <p>1581 USD</p>
              </div>
            </div>
          </div>
            ...
            <table className="min-w-full">
              <thead className="hidden md:table-header-group ltr:text-left rtl:text-right bg-gray-50 rounded-t-lg text-xs font-medium">
                <tr className="*:font-medium *:text-gray-500">
                  <th className="px-3 py-4 whitespace-nowrap">Expense name</th>
                  <th className="px-3 py-4 whitespace-nowrap">Expense date</th>
...
export default ContractExpense;
